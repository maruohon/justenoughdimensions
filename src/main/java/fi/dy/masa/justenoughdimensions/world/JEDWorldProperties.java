...
public class JEDWorldProperties
{
    ...
    public static void createPropertiesFor(World world, NBTTagCompound nbt)
    {
        PROPERTIES.put(world.provider.getDimension(), new JEDWorldProperties(nbt));
    }

    private JEDWorldProperties(NBTTagCompound nbt)
    {
